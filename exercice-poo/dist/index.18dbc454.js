...
class App {
    ...
    whenFormIsSubmit(e) {
        e.preventDefault();
        const newStudent = new Student(this.form.querySelector("#fn-input").value, this.form.querySelector("#ln-input").value, this.form.querySelector("#birthday-input").value, this.form.querySelector("#program-input").value);
    ...
    reorder(e) {
        ...
        while(this.studentsList.firstChild)this.studentsList.removeChild(this.studentsList.firstChild);
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jQVXF","1SICI"], "1SICI", "parcelRequire500e")
